 ...
 * build at Mon Apr 16 2018 10:59:14 GMT+0800 (中国标准时间)
 */
...
(function (global, factory) {
    ...
    var css = ".vue-html5-editor .color-card{margin:2px;width:30px;height:30px;float:left;cursor:pointer}";
    styleInject(css);
        ...
        ! function (e, t) {
            ...
            return function (e) {
                ...
                (function () {
                    ...
                    function u(e) {
                        ...
                        for (var n, r = 2, i = e.byteLength; i > r;) {
                            if (255 != t.getUint8(r)) {
                                return p && console.log("Not a valid marker at offset " + r + ", found: " + t.getUint8(r)), !1;
                            }
                            if (n = t.getUint8(r + 1), p && console.log(n), 225 == n) {
                                return p && console.log("Found 0xFFE1 marker"), g(t, r + 4, t.getUint16(r + 2) - 2);
                            }
                            r += 2 + t.getUint16(r + 2);
                        }
                    }
                    ...
                    function l(e, t, n) {
                        for (var r, i, o, a, u = new DataView(e), c = {}, l = t; t + n > l;) {
                            28 === u.getUint8(l) && 2 === u.getUint8(l + 1) && (a = u.getUint8(l + 2), a in S && (o = u.getInt16(l + 3), i = S[a], r = h(u, l + 5, o), c.hasOwnProperty(i) ? c[i] instanceof Array ? c[i].push(r) : c[i] = [c[i], r] : c[i] = r)), l++;
                        }
                        return c
                    }
                    ...
                    function d(e, t, n, r, i) {
                        ...
                        switch (f) {
                            ...
                            case 5:
                                if (1 == d) {
                                    return c = e.getUint32(g, !i), l = e.getUint32(g + 4, !i), s = new Number(c / l), s.numerator = c, s.denominator = l, s;
                                }
                                for (a = [], u = 0; d > u; u++) {
                    ...
                    function g(e, t) {
                        if ("Exif" != h(e, t, 4)) {
                            return p && console.log("Not valid EXIF data! " + h(e, t, 4)), !1;
                        }
                        var n, r, i, o, a, s = t + 6;
                        if (18761 == e.getUint16(s)) {
                            ...
                            if (19789 != e.getUint16(s)) {
                                return p && console.log("Not valid TIFF data! (no 0x4949 or 0x4D4D)"), !1;
                            }
                            n = !0;
                        }
                        if (42 != e.getUint16(s + 2, !n)) {
                            return p && console.log("Not valid TIFF data! (no 0x002A)"), !1;
                        }
                        var u = e.getUint32(s + 4, !n);
                        if (8 > u) {
                            return p && console.log("Not valid TIFF data! (First offset less than 8)", e.getUint32(s + 4, !n)), !1;
                        }
                ...
                r.prototype.init = function () {
                    ...
                    if (e.img = i, e.blob = c, e.canvas = u, n ? e.fileName = r ? "base64.jpg" : t.split("/").pop() : e.fileName = t.name, !document.createElement("canvas").getContext) {
            ...
            case Command.INSERT_HTML:
                {
                    ...
                    if (div$1.hasChildNodes()) {
                        for (var i$1 = 0; i$1 < div$1.childNodes.length; i$1++) {
                            fragment$1.appendChild(div$1.childNodes[i$1].cloneNode(true));
                        }
                    }
                    this.range.deleteContents();
